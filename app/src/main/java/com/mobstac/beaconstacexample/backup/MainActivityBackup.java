...
import com.mobstac.beaconstacexample.adapter.BeaconAdapter;
...
public class MainActivityBackup extends Activity {
    ...
    BeaconstacReceiver myBroadcastReceiver = new BeaconstacReceiver() {
        ...
        public void campedOnBeacon(Context context, MSBeacon beacon) {
            ...
            beaconAdapter.notifyDataSetChanged();
            ArrayList<Integer> campedBeaconrules = bstacInstance.getRulesForBeacon(beacon.getId());
            MSRule rules = bstacInstance.getRuleForID(campedBeaconrules.get(0));
...
//                    MSActionTypeCustom(5);
            ...
            System.out.println("Rules Name: " + rules.getName() + " Action: " + rules.getActions());
//            if(rules.getActions().equalsIgnoreCase("MSActionTypeNone")){
//
//
//            }
